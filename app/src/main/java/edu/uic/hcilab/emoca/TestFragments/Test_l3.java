...
public class Test_l3 extends android.app.Fragment {
    AudioPlayer ap;
    int audioNum = 0;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ap.audioPlayer(R.raw.l3_inst, mCallback);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_test_l3, container, false);
        viewArr[0] = view.findViewById(R.id.l3_alert);
        viewArr[1] = view.findViewById(R.id.l3_button);
        viewArr[2] = view.findViewById(R.id.l3_text);
        ...
        public void onAudioCallback() {
            switch(audioNum){
                case 0:
                    ...
                    ap.audioAnimationPlayer(R.raw.l3, viewArr, startTimeArr, endTimeArr, mCallback);
                    audioNum = 1;
                    break;
