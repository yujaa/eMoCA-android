...
public class Test_l1 extends android.app.Fragment {
    AudioPlayer ap;
    int audioNum = 0;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ap.audioPlayer(R.raw.l1_inst, mCallback);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_test_l1, container, false);
        viewArr[0] = view.findViewById(R.id.l1_alert);
        viewArr[1] = view.findViewById(R.id.l1_ans);


        sr.setTextViews((TextView)view.findViewById(R.id.l1_ans), (TextView)view.findViewById(R.id.l1_log), getContext());
        toggleReco = (Button)view.findViewById(R.id.l1_toggle_reco);
        ...
        public void onAudioCallback() {
            switch(audioNum){
                case 0:
                    ...
                    ap.audioAnimationPlayer(R.raw.l1, viewArr, startTimeArr, endTimeArr, mCallback);
                    audioNum = 1;
                    break;
