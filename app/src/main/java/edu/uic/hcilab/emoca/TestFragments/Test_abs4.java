...
public class Test_abs4 extends android.app.Fragment {
    AudioPlayer ap;
    int audioNum = 0;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ap.audioPlayer(R.raw.abs4, mCallback);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_test_abs4, container, false);
        viewArr[0] = view.findViewById(R.id.abs4_inst);
        viewArr[1] = view.findViewById(R.id.abs4_button);
        viewArr[2] = view.findViewById(R.id.abs4_text);
